  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
       ...
       <li class="nav-item d-none d-sm-inline-block">
        <a href="../smart/register/register.php" class="nav-link">Add Client</a>
      </li>
...
?>
 ...
 if ($c > 0) {
          ...
          <a href="pages/client.php?uid=<?=$uid?>&name=<?=$rj['name']?>&wallet=<?=$rj['wallet']?>&spent=<?=$rj['spent']?>&debt=<?=$rj['spent']?>" class="dropdown-item">
            <i class="fa fa-user mr-2"></i> <?php echo $rj['name'];?>       
          </a>
